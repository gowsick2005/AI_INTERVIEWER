...
# Restructure React split-layout component markup to remove split-left and split-right wrapping
auth_left_start_tsx = '          <div className="split-left">'
auth_left_end_tsx = '          </div>\n\n          <div className="split-right">'

split_left_start_idx = tsx_updated.find(auth_left_start_tsx)
split_right_start_idx = tsx_updated.find(auth_left_end_tsx)

if split_left_start_idx != -1 and split_right_start_idx != -1:
    print("Stripping React left split decorative panel...")
    part1 = tsx_updated[:split_left_start_idx]
    part2 = tsx_updated[split_right_start_idx + len(auth_left_end_tsx):]
    tsx_updated = part1 + part2
    
    target_closing_tsx = '            )}\n          </div>\n        </div>\n      )}'
    replacement_closing_tsx = '            )}\n        </div>\n      )}'
    
    if target_closing_tsx in tsx_updated:
        tsx_updated = tsx_updated.replace(target_closing_tsx, replacement_closing_tsx)
        print("React split-right closing div stripped successfully!")
    else:
        tsx_updated = tsx_updated.replace('            )}\n          </div>\n        </div>\n      )}', '            )}\n        </div>\n      )}')
...
if start_idx_html != -1 and end_idx_html != -1:
    ...
    # Structural split layout cleanup in HTML
    auth_left_start_html = '      <div class="split-left">'
    auth_left_end_html = '      </div>\n\n      <div class="split-right">'
    
    split_left_start_html_idx = html_updated.find(auth_left_start_html)
    split_right_start_html_idx = html_updated.find(auth_left_end_html)
    
    if split_left_start_html_idx != -1 and split_right_start_html_idx != -1:
        print("Stripping HTML left split decorative panel...")
        part1 = html_updated[:split_left_start_html_idx]
        part2 = html_updated[split_right_start_html_idx + len(auth_left_end_html):]
        html_updated = part1 + part2
        
        target_closing_html = '          <div class="trust-row">\n            <span>🔒 Secure</span>\n            <span>⚡ Instant</span>\n            <span>✅ Free plan</span>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>'
        replacement_closing_html = '          <div class="trust-row">\n            <span>🔒 Secure</span>\n            <span>⚡ Instant</span>\n            <span>✅ Free plan</span>\n          </div>\n        </div>\n    </div>\n  </div>'
        
        if target_closing_html in html_updated:
            html_updated = html_updated.replace(target_closing_html, replacement_closing_html)
            print("HTML split-right closing div stripped successfully!")
        else:
            html_updated = html_updated.replace('          <div class="trust-row">\n            <span>🔒 Secure</span>\n            <span>⚡ Instant</span>\n            <span>✅ Free plan</span>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>', '          <div class="trust-row">\n            <span>🔒 Secure</span>\n            <span>⚡ Instant</span>\n            <span>✅ Free plan</span>\n          </div>\n        </div>\n    </div>\n  </div>')
